...
<div class="tab-container">
    <div class="tab active" id="tab1" onclick="switchTab(1)">Add Bank</div>
    <div class="tab" id="tab2" onclick="switchTab(2)">Bank List</div>
</div>


<div class="tab-content active" id="tabContent1">
    <h3 style="text-align: center;margin-bottom: 5%;background-color: #B885E7; color: white;border: 1px solid">Add bank</h3>
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <form id="bankForm" method="POST" action="{{ route('saveBankInfo') }}" style="padding-left: 10%;padding-right: 10%;">
                    {{ csrf_field() }}
                    <div class="form-group" style="margin-bottom: 2rem;">
                        <label for="bankName">Bank Name:</label>
                        <br>
                        <input type="text" id="categoryName" name="bankName" required>
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom: 2rem;">
                        ...
                        <br>
                        <select id="status" name="status" required style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; transition: all 0.3s ease;">
                    ...
                    <table class="table table-dark">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $bank->status }}</td>
                                <td>
                                    <a href="{{ route('bankInfo') }}" style="background: transparent; border: none;">
                                        <img src="{{ url('assets/images/edit.gif') }}" alt="Delete" style="height: 30px; width: 30px;">
                                    </a>
