...
<div class="tab-container">
    <div class="tab active" id="tab1" onclick="switchTab(1)">Add/Edit Product Category</div>
    <div class="tab" id="tab2" onclick="switchTab(2)">Product Category List</div>
</div>

<div class="tab-content active" id="tabContent1">
    <h3 style="text-align: center;margin-bottom: 4%;">Add/Edit Product Category</h3>
    <form id="categoryForm" action="{{ route('admin.category.store') }}" method="POST" style="padding-left: 10%;padding-right: 10%;">
        {{ csrf_field() }}
        ...
        <div class="form-group">
            ...
            <br>
            <input type="number" id="vatPercentage" name="vatPercentage" required>
        </div>
        <div class="form-group">
