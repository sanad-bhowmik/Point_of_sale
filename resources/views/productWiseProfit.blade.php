...
<div class="tab-container">
    <div class="tab active" id="tab1" onclick="switchTab(1)">Product Wise Profit/Loss</div>
</div>


<div class="tab-content active" id="tabContent1">
    <h3 style="text-align: center;margin-bottom: 5%;background-color: #B885E7; color: white;border: 1px solid">Profit/Loss List</h3>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-dark" id="cashFlowTable">
                        ...
                        <tbody>
                        @foreach($productWiseProfit as $index => $productWiseProfit)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $productWiseProfit->description }}</td>
                                <td>{{ $productWiseProfit->sale_qty }}</td>
                                <td>{{ $productWiseProfit->sale_return_qty }}</td>
                                <td>{{ $productWiseProfit->profit_loss }}</td>
                                <td>{{ $productWiseProfit->created_at }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
