...
<div class="tab-container">
    <div class="tab active" id="tab1" onclick="switchTab(1)" style="display: none;">Sales Return</div>
</div>

<div class="tab-content active" id="tabContent1">
    <h3 style="text-align: center;margin-bottom: 5%;background-color: #B885E7; color: white;border: 1px solid">Sales Return</h3>
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form id="categoryForm" method="POST" action="{{ route('salesReturn.store') }}" style="padding-left: 10%;padding-right: 10%;">
                    {{ csrf_field() }}
