...
<div class="tab-content active" id="tabContent1">
    <h3 style="text-align: center;margin-bottom: 5%;background-color: #B885E7; color: white;border: 1px solid">Journal</h3>
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Acc_journal table</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-dark">
                        ...
                        <tbody>
                            @foreach($accJournalData as $journal)
                            <tr>
                                <td>{{ $journal->id }}</td>
